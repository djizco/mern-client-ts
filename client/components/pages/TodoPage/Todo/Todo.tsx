...
import { Todo } from '_client/types/todos';
...
export default function TodoItem({
  ...
  useEffect(() => {
    const updateMessages = () => {
      setUpdatedMessage(updatedAt ? fromNow(String(updatedAt)) : '');
      setCreatedMessage(fromNow(String(createdAt)));
    };
  ...
  const updateText = (e: React.ChangeEvent<HTMLTextAreaElement>) => setCurrentText(e.target.value);
